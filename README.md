![зображення](https://github.com/user-attachments/assets/73e82b1e-352a-464a-8d8b-2a0bf53aa6d3)
...
- Have `ffmpeg`, `imagemagick`, `yt-dlp`, `node`, and `gallery-dl` on your `PATH`.

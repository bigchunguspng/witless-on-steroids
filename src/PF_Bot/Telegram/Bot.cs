...
namespace PF_Bot.Telegram
{
    public partial class Bot
    {
        ...
        public static async Task<Bot> Create(CommandAndCallbackRouter command)
        {
            ...
            return new Bot(client, me, command);
        }

        private Bot(TelegramBotClient client, User me, CommandAndCallbackRouter command)
        {
            Client   = client;
            Me       =     me;
